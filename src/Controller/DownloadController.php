...
class DownloadController extends AbstractController
{
    ...
    #[Route('/{_locale}/download/{provider}/{aspect}/{parameter}/{question}/{graph}/{field}',
        name: 'download',
        requirements: ['_locale' => '%app.locales%', 'provider' => '[^/]+', 'aspect' => '[^/]+', 'parameter' => '[^/]+', 'question' => '[^/]+', 'graph' => '[^/]+', 'field' => '[^/]+'])
    ]
    public function download(Request $request, string $_locale, string $provider, string $aspect = '', string $parameter = '', string $question = '', string $graph = '', string $field = ''): Response
    {
